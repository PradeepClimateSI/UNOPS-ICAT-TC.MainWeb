...
export class AuthControllerServiceProxy {
    ...
    refresh(body: RefreshReqRes): Observable<void> {
...
export class LoginProfileControllerServiceProxy {
    ...
    getByRole(role: string): Observable<void> {
    ...
    protected processGetByRole(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateStatus(role: string): Observable<void> {
    ...
    protected processSyncCountry(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateOneLoginProfile(body: LoginProfile): Observable<void> {
    ...
    protected processUpdateOneLoginProfile(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
